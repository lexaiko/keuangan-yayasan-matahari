...
class DetailSppSudahBayarWidget extends BaseWidget
{
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ->query($query)
            ->heading("Daftar Siswa Sudah Bayar SPP {$bulanIni}")
            ->description('Siswa yang sudah melunasi pembayaran SPP bulan ini')
            ->columns([
